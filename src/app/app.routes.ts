...
export const routes: Routes = [
    ...
    {
        path: 'mantenimiento', component: SesionLayoutComponent,
        children: [
            { path: '', loadComponent: () => import('./pages/mantenimiento/listado/listado.component') },
            { path: 'nuevo', loadComponent: () => import('./pages/mantenimiento/nuevo/nuevo.component') },
            { path: '', redirectTo: '', pathMatch: 'full' }
        ]
    },
